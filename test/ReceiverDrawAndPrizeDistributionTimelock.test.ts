...
describe('ReceiverDrawAndPrizeDistributionTimelock', () => {
    ...
    let drawAndPrizeDistributionTimelockFactory: ContractFactory;
    ...
    beforeEach(async () => {
        ...
        drawAndPrizeDistributionTimelockFactory = await ethers.getContractFactory(
            'ReceiverDrawAndPrizeDistributionTimelock',
        );
